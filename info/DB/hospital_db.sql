...
--
-- Host: localhost:3306
-- Generation Time: Oct 07, 2023 at 01:05 PM
...
(1, 'Adminstrator', 'Admin@mail.com', NULL, '$2y$10$JwrMRtf94Vj2pcbaG7SlGevsz.OiYYEgGsD9mLHeDx01rGPPih1Yi', NULL, NULL, NULL, NULL);
...
(5, '2023_08_24_062512_create_admins_table', 1),
(6, '2023_09_11_095724_create_sections_table', 1),
(7, '2023_09_11_095756_create_section_translations_table', 1);
...
(20, 'Mohamed', 'mohamed@mail.com', NULL, '$2y$10$gKXov.e4pPrJLSUSP/13.O6IdzREc1ZZe06iAvW6p7GlcrQSq1/k6', NULL, NULL, NULL);
...
ALTER TABLE `section_translations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `section_id` (`locale`),
