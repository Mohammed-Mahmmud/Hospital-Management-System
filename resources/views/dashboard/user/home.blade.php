                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-0">Here's what's happening with User Panel 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            ...
                                            <div class="avatar-sm flex-shrink-0">
                                                <span
                                                    class="avatar-title bg-white bg-opacity-10 rounded fs-3">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div
                                                                    class="avatar-sm bg-light rounded p-1 me-2">
                                                                    <img src="{{asset("dashboard/assets/images/products/img-4.png")}}"
                                                                        alt=""
                                                                        class="img-fluid d-block">
                                                                </div>
                                                                <div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{asset("dashboard/assets/images/companies/img-8.png")}}"
                                                                        alt=""
                                                                        class="avatar-sm p-2">
                                                                </div>
                                                                <div class="flex-grow-1">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div data-simplebar="" style="max-height: 410px;" class="p-3 pt-0">
                                    <div class="acitivity-timeline acitivity-main">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div
                                                    ...
                                                    <a href="apps-ecommerce-product-details.html"
                                                        ...
                                                        <img src="{{asset("dashboard/assets/images/products/img-8.png")}}"
                                                    ...
                                                    <a href=""
                                                        class="bg-light rounded p-1">
                                                        <img src="{{asset("dashboard/assets/images/products/img-10.png")}}"
                                                            alt="" class="img-fluid d-block">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{asset("dashboard/assets/images/users/avatar-2.jpg")}}" alt=""
                                        ...
                                        <div class="acitivity-item d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{asset("dashboard/assets/images/users/avatar-3.jpg")}}" alt=""
                                                    class="avatar-xs rounded-circle acitivity-avatar">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="text-center">
                                        <div class="text-muted">Total <span
                                                class="fw-semibold">5.50k</span>reviews</div>
                                    </div>
